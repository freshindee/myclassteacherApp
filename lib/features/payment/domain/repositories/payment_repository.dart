...
abstract class PaymentRepository {
  ...
  Future<Either<Failure, List<Payment>>> getUserPayments(String userId, {String? schoolId});
  Future<Either<Failure, PayAccountDetails?>> getPayAccountDetails(String schoolId);
} 